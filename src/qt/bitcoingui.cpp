                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ValinorCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ValinorCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and valinorcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ValinorCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ValinorCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ValinorCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ValinorCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ValinorCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a ValinorCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ValinorCoin Core help message to get a list with possible ValinorCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ValinorCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ValinorCoin network", "", count));
}
...
{
    QString strTitle = tr("ValinorCoin Core"); // default title
