...
/** Utility functions used by the ValinorCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ValinorCoin addresses in monospace font
...
// Parse "valinorcoin:" URI into recipient object, return true on successful parsing
