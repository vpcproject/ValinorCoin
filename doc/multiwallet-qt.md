...
In order to support loading of multiple wallets in valinorcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is valinorcoin.cpp.
...
Changes to valinorcoin.cpp
----------------------
valinorcoin.cpp is the entry point into valinorcoin-qt, and as such, will require some minor modifications to provide hooks for
